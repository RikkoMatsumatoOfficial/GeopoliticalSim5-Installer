...
AppId={{AB8ECCB3-65B6-432C-B075-834B231F4B4B}
AppName={#MyAppName}
...
begin
    ExtractTemporaryFile('GPS5MainTheme.mp3');
    mp3Name := ExpandConstant('{tmp}\GPS5MainTheme.mp3');
...
[Files]
Source: "GPS5MainTheme.mp3"; DestDir: "{tmp}"; Flags: dontcopy ignoreversion deleteafterinstall
Source: "C:\Include_DLLInnoSetup\bass.dll"; DestDir: {tmp}; Flags: dontcopy ignoreversion deleteafterinstall
Source: "F:\Games\GeoPoliticalSim5\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\Games\GeoPoliticalSim5\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
